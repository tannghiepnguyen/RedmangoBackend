...
namespace Redmango_API.Migrations
{
    ...
    [Migration("20240603022408_removeStripeFromShoppingCart")]
            ...
            modelBuilder.Entity("Redmango_API.Models.MenuItem", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f8d6e835-7ec1-4852-befd-97a1470665df"),
                            Category = "Appetizer",
                        ...
                        new
                        {
                            Id = new Guid("0499f82e-f217-46e3-ae95-c4241dc35e35"),
                            Category = "Appetizer",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("6d904b78-d203-4708-83a2-f3eefc273d77"),
                            Category = "Appetizer",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("07a11d18-5e3d-4fc1-9036-1dd898f6c51b"),
                            Category = "Entrée",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("4e598189-8678-4925-bbaf-39222dd73245"),
                            Category = "Entrée",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("53f918f9-711c-4ca2-83db-efcafe914056"),
                            Category = "Entrée",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("db80b729-ad6d-4a9d-85ab-1e0f8ceeb91f"),
                            Category = "Entrée",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("d1859af3-53d8-438f-9cf5-0955810ed4ed"),
                            Category = "Dessert",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("2c255899-8765-4672-a2d3-afc136c6fc8c"),
                            Category = "Dessert",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
                        ...
                        new
                        {
                            Id = new Guid("bb4dd9ae-5f00-4582-87bc-65a6cae72449"),
                            Category = "Dessert",
                            Description = "Fusc tincidunt maximus leo, sed scelerisque massa auctor sit amet. Donec ex mauris, hendrerit quis nibh ac, efficitur fringilla enim.",
